...
//        invitationCodeDao.update(code);
    ...
    @RequestMapping("/user-account/findback-account")
    public CommonResponse updatePwd(@RequestBody UpdatePwdReq req) {
        return CommonResponse.success(sysUserService.updatePwd(req));
    }
